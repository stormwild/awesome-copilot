...
|----------|-------------------|
| Highest capability reasoning, deep research | Claude Opus 5 *(v1.0.75+)* |
...
| Fast code and tool tasks (Google) | gemini-3.6-flash *(v1.0.74+)* |
| Tool-rich agentic tasks (xAI) | grok-4.5 *(v1.0.76+)* |
