...
prerequisites:
  - Access to the GitHub Copilot app or GitHub Copilot CLI (v1.0.71+ for CLI canvases)
---
...
Canvases are available in the **GitHub Copilot app** (create with `/create-canvas`) and, as of v1.0.71+, in the **GitHub Copilot CLI** (extension-driven canvas interactions).
