...
Starting in **v1.0.71**, canvas support is also available in the **GitHub Copilot CLI** for extension-driven interactions. Extensions that register canvas capabilities can open and update canvases from within CLI agent sessions, giving you the same bidirectional surface outside the desktop app.
